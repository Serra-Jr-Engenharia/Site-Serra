 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(z,A){var F=z.length;z.push(A);e:for(;0<F;){var V=F-1>>>1,$=z[V];if(0<i($,A))z[V]=A,z[F]=$,F=V;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var A=z[0],F=z.pop();if(F!==A){z[0]=F;e:for(var V=0,$=z.length,E=$>>>1;V<E;){var U=2*(V+1)-1,D=z[U],b=U+1,K=z[b];if(0>i(D,F))b<$&&0>i(K,D)?(z[V]=K,z[b]=F,V=b):(z[V]=D,z[U]=F,V=U);else if(b<$&&0>i(K,F))z[V]=K,z[b]=F,V=b;else break e}}return A}function i(z,A){var F=z.sortIndex-A.sortIndex;return F!==0?F:z.id-A.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var s=[],u=[],c=1,d=null,p=3,h=!1,g=!1,y=!1,k=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(z){for(var A=n(u);A!==null;){if(A.callback===null)r(u);else if(A.startTime<=z)r(u),A.sortIndex=A.expirationTime,t(s,A);else break;A=n(u)}}function x(z){if(y=!1,v(z),!g)if(n(s)!==null)g=!0,X(P);else{var A=n(u);A!==null&&fe(x,A.startTime-z)}}function P(z,A){g=!1,y&&(y=!1,m(S),S=-1),h=!0;var F=p;try{for(v(A),d=n(s);d!==null&&(!(d.expirationTime>A)||z&&!M());){var V=d.callback;if(typeof V=="function"){d.callback=null,p=d.priorityLevel;var $=V(d.expirationTime<=A);A=e.unstable_now(),typeof $=="function"?d.callback=$:d===n(s)&&r(s),v(A)}else r(s);d=n(s)}if(d!==null)var E=!0;else{var U=n(u);U!==null&&fe(x,U.startTime-A),E=!1}return E}finally{d=null,p=F,h=!1}}var C=!1,_=null,S=-1,T=5,j=-1;function M(){return!(e.unstable_now()-j<T)}function R(){if(_!==null){var z=e.unstable_now();j=z;var A=!0;try{A=_(!0,z)}finally{A?L():(C=!1,_=null)}}else C=!1}var L;if(typeof f=="function")L=function(){f(R)};else if(typeof MessageChannel<"u"){var G=new MessageChannel,Y=G.port2;G.port1.onmessage=R,L=function(){Y.postMessage(null)}}else L=function(){k(R,0)};function X(z){_=z,C||(C=!0,L())}function fe(z,A){S=k(function(){z(e.unstable_now())},A)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(z){z.callback=null},e.unstable_continueExecution=function(){g||h||(g=!0,X(P))},e.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<z?Math.floor(1e3/z):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(z){switch(p){case 1:case 2:case 3:var A=3;break;default:A=p}var F=p;p=A;try{return z()}finally{p=F}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(z,A){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var F=p;p=z;try{return A()}finally{p=F}},e.unstable_scheduleCallback=function(z,A,F){var V=e.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?V+F:V):F=V,z){case 1:var $=-1;break;case 2:$=250;break;case 5:$=1073741823;break;case 4:$=1e4;break;default:$=5e3}return $=F+$,z={id:c++,callback:A,priorityLevel:z,startTime:F,expirationTime:$,sortIndex:-1},F>V?(z.sortIndex=F,t(u,z),n(s)===null&&z===n(u)&&(y?(m(S),S=-1):y=!0,fe(x,F-V))):(z.sortIndex=$,t(s,z),g||h||(g=!0,X(P))),z},e.unstable_shouldYield=M,e.unstable_wrapCallback=function(z){var A=p;return function(){var F=p;p=A;try{return z.apply(this,arguments)}finally{p=F}}}})(vf);(function(e){e.exports=vf})(mf);/**
 * @license React
 ...
 *
 * @license MIT
 */function Ts(){return Ts=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Ts.apply(this,arguments)}function My(e,t){if(e==null)return{};var n={},r=Object.keys(e),i,o;for(o=0;o<r.length;o++)i=r[o],!(t.indexOf(i)>=0)&&(n[i]=e[i]);return n}const Ry=["onClick","reloadDocument","replace","state","target","to"];function Ay(e){let{basename:t,children:n,window:r}=e,i=q.exports.useRef();i.current==null&&(i.current=ay({window:r}));let o=i.current,[l,a]=q.exports.useState({action:o.action,location:o.location});return q.exports.useLayoutEffect(()=>o.listen(a),[o]),q.exports.createElement(zy,{basename:t,children:n,location:l.location,navigationType:l.action,navigator:o})}function Dy(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}const wt=q.exports.forwardRef(function(t,n){let{onClick:r,reloadDocument:i,replace:o=!1,state:l,target:a,to:s}=t,u=My(t,Ry),c=Oy(s),d=Ny(s,{replace:o,state:l,target:a});function p(h){r&&r(h),!h.defaultPrevented&&!i&&d(h)}return q.exports.createElement("a",Ts({},u,{href:c,onClick:p,ref:n,target:a}))});function Ny(e,t){let{target:n,replace:r,state:i}=t===void 0?{}:t,o=Py(),l=ja(),a=Mh(e);return q.exports.useCallback(s=>{if(s.button===0&&(!n||n==="_self")&&!Dy(s)){s.preventDefault();let u=!!r||Os(l)===Os(a);o(e,{replace:u,state:i})}},[l,o,a,r,i,n,e])}const W={mobile:"390px",largeMobile:"500px",tablet:"820px",notebook:"1024px",largeNotebook:"1440px",desktop:"1920px",largeDesktop:"2560px",extraLargeDesktop:"3840px"},$y=O.ul`
    display: flex;
    align-items: center;
...
`,Wy=O.div`
    ...
    @media screen and (min-width: ${W.largeNotebook}){
        width: 10vw;
    }

    @media screen and (min-width: ${W.largeDesktop}){
        width: 10vw;
    }
`;O.div`
    width: 95%;
...
`,Vy=()=>{const[e,t]=q.exports.useState(!1);return w(By,{children:H($y,{children:[w(Wi,{children:w(wt,{to:"/",children:"Home"})}),w(Wi,{children:w(wt,{to:"/quemSomos",children:"Sobre N\xF3s"})}),w(Wi,{children:H(Fy,{onClick:()=>t(!e),children:[H(Uy,{children:[w(Iy,{children:"Servi\xE7os"}),w(Hy,{activeStyle:e,src:iy,alt:"Seta"})]}),H(Wy,{activeStyle:e,children:[w(Od,{children:w(wt,{to:"/computacao",children:"Computa\xE7\xE3o"})}),w(Od,{children:w(wt,{to:"/mecanica",children:"Mec\xE2nica"})})]})]})}),w(Wi,{children:w(wt,{to:"/contatos",children:"Contato"})})]})})},Pr=O.div`
    display: flex;
    justify-content: center;
    align-items: center;
    font-size: 1.4rem;
    ...
    @media screen and (min-width: ${W.extraLargeDesktop}) {
        width: 100%;
        height: 100%;
        font-size: 2.5rem;
    }
...
`,Gy=({status:e})=>H(Qy,{activeStyle:e,children:[w(Pr,{children:w(wt,{to:"/",children:"Home"})}),w(Pr,{children:w(wt,{to:"/quemSomos",children:"Sobre N\xF3s"})}),w(Pr,{children:w(wt,{to:"/computacao",children:"Computa\xE7\xE3o"})}),w(Pr,{children:w(wt,{to:"/mecanica",children:"Mec\xE2nica"})}),w(Pr,{children:w(wt,{to:"/contatos",children:"Contatos"})})]}),vl=O.div`
    height: 3px;
    background-color: #fff;
    width: 30px;
    margin: 3px;
...
`,Xy=({status:e})=>(console.log(e),H(Yy,{children:[w(vl,{active:e,type:"first-line"}),w(vl,{active:e,type:"mid-line"}),w(vl,{active:e,type:"last-line"})]})),qy=O.img`
    width: 12rem;
    margin-left: 25%;
...
`,Ky=O.div`
    ...
    @media screen and (max-width: ${W.notebook}){
        justify-content: space-between;
        align-items: center;
    }
    @media screen and (min-width: ${W.largeDesktop}){
...
`,Jy=O.div`
    margin-right: 7%;
`,Zy=()=>{const[e,t]=q.exports.useState(!1);return H(Ky,{children:[w(wt,{to:"/",children:w(qy,{src:ry,alt:"Logo Serra Jr"})}),w(Jy,{onClick:()=>{t(!e)},children:w(Xy,{status:e})}),w(Vy,{}),w(Gy,{status:e})]})},e1=O.img`
    height: 15vh;
...
`,n1=O.div`
    ...
    @media screen  and (max-width: ${W.tablet}){
        margin-top: 30px;
        margin-bottom: 0;
    }
`,r1=({icon:e,text:t,alt:n})=>H(n1,{children:[w(e1,{src:e,alt:n}),w(t1,{children:t})]}),i1=O.div`
...
`,Pd=({title:e,buttonUrl:t,buttonTitle:n,color:r,images:i,texts:o})=>H(u1,{children:[w(o1,{titleColor:r,children:e}),H(i1,{children:[w(s1,{children:i.map((l,a)=>w(r1,{icon:l,text:o[a],alt:o[a]},a))}),w(a1,{href:t,children:w(l1,{buttonColor:r,children:n})})]})]}),c1=O.p`
    font-family: 'Maven Pro';
    font-style: normal;
    font-weight: 500;
    font-size: 48px;
    ...
    @media screen and (max-width: ${W.largeMobile}) {
        font-size: 40px;
    }

    @media screen and (min-width: ${W.notebook}) {
        font-size: 38px;
        width: 80%;
    }
...
`,hx=e=>{const t={dots:!0,infinite:!0,speed:1e3,slidesToShow:1,slidesToScroll:1,arrows:!1,autoplay:!0,autoplaySpeed:2500};return w(px,{containerWidth:e.width,children:w(lm,{...t,children:e.carouselData.map((n,r)=>w(cx,{children:w(dx,{children:w(fx,{src:n.image,alt:n.alt})})},r))})})},mx="/Site-Serra/assets/membros-1.26cb4867.svg",vx="/Site-Serra/assets/membros-2.457898e5.svg",gx="/Site-Serra/assets/missao-icon.4dc65479.svg",yx="/Site-Serra/assets/visao-icon.75e2e4de.svg",wx="/Site-Serra/assets/valores-icon.b6d7390b.svg",Oe={members:[{image:mx,alt:"Foto tirada na \xFAltima imers\xE3o da Serra Jr. Engenharia"},{image:vx,alt:"Foto tirada na \xFAltima imers\xE3o da Serra Jr. Engenharia"}],membersText:"A Serra Jr. Engenharia, \xE9 uma Empresa J\xFAnior vinculada ao Instituto Polit\xE9cnico da Universidade do Estado do Rio de Janeiro, localizada em Nova Friburgo. Tem como escopo a presta\xE7\xE3o de servi\xE7os como prototipagem, automa\xE7\xE3o, desenho t\xE9cnico industrial, projeto e manuten\xE7\xE3o de equipamentos e o desenvolvimento de websites e sistemas web. Tem como membros alunos dos cursos de Engenharia Mec\xE2nica e de Computa\xE7\xE3o atuando em regime de voluntariado, determinados a adquirir experi\xEAncia colocando seus conhecimentos em pr\xE1tica, com o objetivo de trazer inova\xE7\xE3o e excel\xEAncia ao mercado. Al\xE9m disso, conta com o suporte e orienta\xE7\xE3o dos professores doutores e t\xE9cnicos da institui\xE7\xE3o. O faturamento \xE9 integralmente destinado \xE0 manuten\xE7\xE3o financeira da empresa e para o desenvolvimento t\xE9cnico e intelectual de seus membros, com cursos, treinamentos ou outras oportunidades que contribuam para a capacita\xE7\xE3o profissional, al\xE9m das viv\xEAncias experienciadas na Universidade.",icons:[{image:gx,imageAlt:"Miss\xE3o",titleText:"Miss\xE3o",hasList:!1,list:void 0,content:"Promover o desenvolvimento e evolu\xE7\xE3o dos acad\xEAmicos para que sejam capazes de impactar e agregar valores \xE0s pessoas e empresas de Nova Friburgo e regi\xE3o, atrav\xE9s de projetos mec\xE2nicos e de computa\xE7\xE3o."},{image:yx,imageAlt:"Vis\xE3o",titleText:"Vis\xE3o",hasList:!1,list:void 0,content:"Idealizar nossa empresa como exemplo em inova\xE7\xE3o e qualidade de servi\xE7os."},{image:wx,imageAlt:"Valores",titleText:"Valores",hasList:!0,list:["Dedica\xE7\xE3o por excel\xEAncia","Gest\xE3o segura","Impactar nossa era","Evolu\xE7\xE3o constante","Responsabilidade com os clientes"],content:void 0}]},xx=O.div`
    width: 100%;
    height: 6rem;
    min-height: 30px;
    background-color: ${({titleColor:e})=>e!=null?e:"#FD6300"};
...
`,jx=()=>w(Tx,{children:w(Px,{onInit:e=>{e.typeString("Engrenando ideias, inovando o mercado.").pauseFor(2e3).deleteAll().start()},options:{wrapperClassName:"writer",cursorClassName:"writer-cursor",loop:!0}})}),zx="/Site-Serra/assets/presentation-image.40ce3de4.png",Lx="/Site-Serra/assets/Sites.a0112d0d.svg",Mx="/Site-Serra/assets/sistemas-web.d1b27032.svg",Rx="/Site-Serra/assets/manutencao.33f9dd1a.svg",Ax="/Site-Serra/assets/desenho-tecnico.22fbb0fb.svg",Dx="/Site-Serra/assets/braco-robo.2b026e48.svg",Nx="/Site-Serra/assets/impressora-3d.75613d7d.svg",$x="/Site-Serra/assets/nossa-historia.432df2d8.svg",Ix="/Site-Serra/assets/background-image.668c0125.svg",Fx=O.div`
...
`,Ol=({image:e,titleText:t,imageAlt:n,hasList:r,content:i,list:o})=>H(Yx,{children:[w(Jx,{src:e,alt:n}),w(za,{titleWidth:"50%",fontSize:"30px",text:t}),r?w(qx,{children:o?o.map((l,a)=>w(Kx,{children:l},a)):null}):w(Xx,{children:i})]}),Zx=O.div`
...
`,oS=()=>H(Ph,{children:[w(eS,{children:H(Zx,{children:[w(nS,{children:"Sobre N\xF3s"}),w(rS,{src:Gx,alt:"imagem sobre n\xF3s"})]})}),w(tS,{children:H(iS,{children:[w(Ol,{image:Oe.icons[0].image,imageAlt:Oe.icons[0].imageAlt,list:Oe.icons[0].list,hasList:Oe.icons[0].hasList,content:Oe.icons[0].content,titleText:Oe.icons[0].titleText}),w(Kd,{}),w(Ol,{image:Oe.icons[1].image,imageAlt:Oe.icons[1].imageAlt,list:Oe.icons[1].list,hasList:Oe.icons[1].hasList,content:Oe.icons[1].content,titleText:Oe.icons[1].titleText}),w(Kd,{}),w(Ol,{image:Oe.icons[2].image,imageAlt:Oe.icons[2].imageAlt,list:Oe.icons[2].list,hasList:Oe.icons[2].hasList,content:Oe.icons[2].content,titleText:Oe.icons[2].titleText})]})}),w(sm,{title:"Quem Somos",color:"#001830",hasButton:!1,hasCarousel:!0})]}),aS=O.div`
    width: 100%;
    height: 100%;
    display: flex;
    justify-content: center;
...
`,fk=()=>H(JS,{children:[H(ek,{children:[H(tk,{children:[w(Jd,{children:"Engenharia"}),w(Jd,{children:"Mec\xE2nica"})]}),w(ik,{src:QS,alt:"Imagem de Mec\xE2nica"})]}),H(ZS,{children:[w(nk,{children:"Carta de Servi\xE7os"}),w(rk,{children:"Engenharia Mec\xE2nica"}),H(Zd,{children:[H(Zi,{children:[H(eo,{children:[w(Bt,{src:GS,alt:"Imagem Sistemas"}),w(Ki,{children:"Projeto e Manuten\xE7\xE3o de Equipamentos"})]}),H(to,{children:[w(Bt,{src:qi,alt:"Seta"}),w(Ji,{children:"Como nosso principal servi\xE7o, desenvolvemos os mais diversos equipamentos para atender cada demanda da melhor maneira. Assim, nosso time ir\xE1 estudar a fundo a necessidade do cliente para ent\xE3o passar por cada fase do projeto, apresentando um estudo minucioso, seu desenho t\xE9cnico, op\xE7\xF5es de prot\xF3tipo e ent\xE3o colocando na pr\xE1tica e suas necess\xE1rias manuten\xE7\xF5es."})]})]}),H(Zi,{children:[H(eo,{children:[w(Bt,{src:qS,alt:"Imagem Site"}),w(Ki,{children:"Desenho T\xE9cnico e Industrial"})]}),H(to,{children:[w(Bt,{src:qi,alt:"Seta"}),w(Ji,{children:"Com aux\xEDlio de programas CAD, a Serra Jr oferece servi\xE7os de desenhos de pe\xE7as e maquin\xE1rios, em 2D e 3D, para dar vida ao conceito proposto pelo cliente seguindo todas as normas necess\xE1rias nesse processo t\xE3o significante de um projeto."})]})]})]}),H(Zd,{children:[H(Zi,{children:[H(eo,{children:[w(Bt,{src:YS,alt:"Imagem Sistemas"}),w(Ki,{children:"Projetos de Automa\xE7\xE3o"})]}),H(to,{children:[w(Bt,{src:qi,alt:"Seta"}),w(Ji,{children:"A partir da demanda do cliente desenvolvemos projetos para automa\xE7\xE3o e otimiza\xE7\xE3o de tarefas. Tendo em vista que o tempo \xE9 um recurso precioso e precisa ser sempre melhor aproveitado, nosso time ir\xE1 desenvolver o melhor estudo para otimiza\xE7\xE3o do seu projeto al\xE9m de cria\xE7\xE3o de prot\xF3tipos usando microcontroladores, CLP's e outras tecnologias da ind\xFAstria 4.0."})]})]}),H(Zi,{children:[H(eo,{children:[w(Bt,{src:XS,alt:"Imagem Site"}),w(Ki,{children:"Prototipagem"})]}),H(to,{children:[w(Bt,{src:qi,alt:"Seta"}),w(Ji,{children:"A experimenta\xE7\xE3o de ideias iniciais de um projeto \xE9 uma fase muito importante de seu desenvolvimento, e por isso a utiliza\xE7\xE3o de prot\xF3tipos antes do projeto final \xE9 essencial. Na Serra Jr contamos com equipamentos como impressoras 3D e CNC de corte a laser onde nossos membros capacitados podem desenvolver o melhor prot\xF3tipo a baixo custo de seu projeto."})]})]})]})]}),w(ok,{}),w(lk,{children:w(ak,{children:"Quer colocar um projeto em pr\xE1tica? \u2192"})}),w(dk,{children:w(dm,{carouselData:VS.mechanicsProjects})}),H(sk,{children:[w(uk,{src:fm,alt:"WhatsApp"}),w(ck,{onClick:()=>window.scrollTo(0,0),src:pm,alt:"ScrollUp"})]})]}),pk="/Site-Serra/assets/friburguense.ba8886f5.svg",hk="/Site-Serra/assets/projeto-tmf.f6316197.svg",mk={computingProjects:[{title:"Projeto Friburguense",image:pk,content:`O projeto consistiu no desenvolvimento de um Website voltado \xE0 aquisi\xE7\xE3o de planos 
            ...
            localiza\xE7\xE3o da mesma.`}]},vk="/Site-Serra/assets/presentation-image.3bba7d23.svg",gk="/Site-Serra/assets/desenvolvimento-sistemas.4c3d58c3.svg",yk="/Site-Serra/assets/desenvolvimento-sites.db29c127.svg",ef="/Site-Serra/assets/seta.02d723b8.svg",wk="/Site-Serra/assets/css-icon.e1a4dd78.svg",xk="/Site-Serra/assets/html-icon.e0dc6b68.svg",Sk="/Site-Serra/assets/js-icon.f4d001af.svg",kk="/Site-Serra/assets/react-icon.f937629c.svg",Ek="/Site-Serra/assets/ts-icon.bf061be4.svg",_k="/Site-Serra/assets/styled-icon.35b18102.svg",Ck="/Site-Serra/assets/background-computacao.8bb805be.svg",bk=O.div`
...
`,Pk=O.img`
    ...
    @media screen and (max-width: ${W.extraLargeDesktop}){
        width: 30%;
    }
...
`,Hk=O.hr`
    ...
    border: 0;
    background: linear-gradient(90deg, rgba(4,173,215,1) 0%, rgba(4,173,215,1) 41%, rgba(255,116,0,1) 69%);
`,Uk=()=>H(bk,{children:[H(Ok,{children:[H(jk,{children:[w(Pl,{children:"Engenharia"}),w(Pl,{children:"de"}),w(Pl,{children:"Computa\xE7\xE3o"})]}),w(Pk,{src:vk,alt:"Imagem de Computa\xE7\xE3o"})]}),H(Tk,{children:[w(zk,{children:"Carta de Servi\xE7os"}),w(Lk,{children:"Engenharia de Computa\xE7\xE3o"}),H(Mk,{children:[H(tf,{children:[H(nf,{children:[w(no,{src:yk,alt:"Imagem Site"}),w(of,{children:"Desenvolvimento de Websites"})]}),H(af,{children:[w(no,{src:ef,alt:"Seta"}),w(rf,{children:"Desenvolvemos do zero um site pensado exclusivamente para atender as necessidades do seu neg\xF3cio. Utilizamos das ferramentas mais modernas do mercado para criar uma solu\xE7\xE3o \xFAnica que ir\xE1 alavancar a visibilidade do seu produto!"})]})]}),H(tf,{children:[H(nf,{children:[w(no,{src:gk,alt:"Imagem Sistemas"}),w(of,{children:"Desenvolvimento de Sistemas Web"})]}),H(af,{children:[w(no,{src:ef,alt:"Seta"}),w(rf,{children:"Com aux\xEDlio das mais completas linguagens de programa\xE7\xE3o, fornecemos aplicativos e sistemas pr\xF3prios para a sua empresa que ir\xE3o acelerar e auxiliar internamente no gerenciamento e desenvolvimento do seu neg\xF3cio."})]})]})]}),H(Rk,{children:[w(Rn,{children:w(An,{src:xk,alt:"ImagemHtml"})}),w(Rn,{children:w(An,{src:wk,alt:"Imagemcss"})}),w(Rn,{children:w(An,{src:Sk,alt:"ImagemJS"})}),w(Rn,{children:w(An,{src:Ek,alt:"ImagemTS"})}),w(Rn,{children:w(An,{src:kk,alt:"ImagemREACT"})}),w(Rn,{children:w(An,{src:_k,alt:"ImagemStyled"})})]})]}),w(Hk,{}),w(Fk,{children:w(Ik,{children:"Quer colocar um projeto em pr\xE1tica? \u2192"})}),w($k,{children:w(dm,{carouselData:mk.computingProjects})}),H(Nk,{children:[w(Ak,{src:fm,alt:"WhatsApp"}),w(Dk,{onClick:()=>window.scrollTo(0,0),src:pm,alt:"ScrollUp"})]})]}),Wk=()=>H(Ph,{children:[w(Zy,{}),H(Ly,{children:[w(Dn,{path:"/",element:w(Qx,{})}),w(Dn,{path:"/computacao",element:w(Uk,{})}),w(Dn,{path:"/mecanica",element:w(fk,{})}),w(Dn,{path:"/quemSomos",element:w(oS,{})}),w(Dn,{path:"/contatos",element:w(LS,{})})]}),w(ny,{})]});function Bk(){return w("div",{className:"App",children:w(Ay,{basename:"/Site-Serra",children:w(Wk,{})})})}Tl.createRoot(document.getElementById("root")).render(w(pi.StrictMode,{children:w(Bk,{})}));
